...
/**
 * The file:path-to-native function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.path-to-native
 * @see http://expath.org/spec/file/20131203#fn.path-to-native
 */
public class PathToNative
        extends Function
{
    public PathToNative(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            String res = paths.pathToNative(path);
    ...
    private static final String LOCAL_NAME = "path-to-native";
