...
/**
 * The file:parent function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.parent
 * @see http://expath.org/spec/file/20131203#fn.parent
 */
public class Parent
        extends Function
{
    public Parent(Library lib)
    {
        super(lib);
    }
            ...
            throws XPathException
    {
        ...
        String res = paths.parent(path);
        return Return.value(res);
    }

    private static final String LOCAL_NAME = "parent";
