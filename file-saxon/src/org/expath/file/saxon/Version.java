...
public class Version
{
    protected Version()
    {
        ...
        // get both properties
        myVersion  = props.getProperty("org.expath.file.saxon.version");
        myRevision = props.getProperty("org.expath.file.saxon.revision");
    }
    ...
    {
        out.println("EXPath File for Saxon.");
    ...
    private static final String  VER_PROP = "/org/expath/file/saxon/version.properties";
