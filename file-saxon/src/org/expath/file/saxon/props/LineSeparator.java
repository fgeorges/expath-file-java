...
/**
 * The file:line-separator function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#pr.line-separator
 * @see http://expath.org/spec/file/20131203#pr.line-separator
 */
public class LineSeparator
        extends Function
{
    public LineSeparator(Library lib)
    {
        super(lib);
    }
            ...
            throws XPathException
    {
        ...
        String res = props.lineSeparator();
        return Return.value(res);
    }

    private static final String LOCAL_NAME = "line-separator";
}
