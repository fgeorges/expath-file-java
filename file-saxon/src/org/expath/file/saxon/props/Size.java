 ...
 * @date   2015-01-14
 * @see http://expath.org/spec/file#pr.size
 * @see http://expath.org/spec/file/20131203#pr.size
 */
public class Size
        extends Function
{
    public Size(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
    ...
    private static final String LOCAL_NAME = "size";
