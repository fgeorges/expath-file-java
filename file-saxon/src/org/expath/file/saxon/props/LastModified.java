...
/**
 * The file:last-modified function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#pr.last-modified
 * @see http://expath.org/spec/file/20131203#pr.last-modified
 */
public class LastModified
        extends Function
{
    public LastModified(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            Date res = props.lastModified(path);
            return Return.value(res, true);
        }
    ...
    private static final String LOCAL_NAME = "last-modified";
