...
/**
 * The file:write-text function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.write-text
 * @see http://expath.org/spec/file/20131203#fn.write-text
 */
public class WriteText
        extends Function
{
    public WriteText(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            if ( orig_params.length == 2 ) {
                write.writeText(file, value);
            }
            else {
                String encoding = params.asString(2, false);
                write.writeText(file, value, encoding);
            }
            return Return.empty();
        }
    ...
    private static final String LOCAL_NAME  = "write-text";
