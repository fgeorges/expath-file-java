...
/**
 * The file:append function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.append
 * @see http://expath.org/spec/file/20131203#fn.append
 */
public class Append
        extends Function
{
    public Append(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            if ( orig_params.length == 2 ) {
                write.append(file, items);
            }
            else {
                Element ser_params = params.asElement(2, false, ctxt);
                write.append(file, items, ser_params);
            }
            return Return.empty();
        }
    ...
    private static final String LOCAL_NAME   = "append";
