...
/**
 * The file:append-text function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.append-text
 * @see http://expath.org/spec/file/20131203#fn.append-text
 */
public class AppendText
        extends Function
{
    public AppendText(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws ToolsException
    {
        return library()
                ...
                .param(Types.SINGLE_STRING, PARAM_VALUE)
                .optional()
            ...
            throws XPathException
    {
        ...
        String value = params.asString(1, false);
        // the actual call
        try {
            Write write = new Write();
            if ( orig_params.length == 2 ) {
                write.appendText(file, value);
            }
            else {
                String encoding = params.asString(2, false);
                write.appendText(file, value, encoding);
            }
            return Return.empty();
        }
    ...
    private static final String LOCAL_NAME  = "append-text";
