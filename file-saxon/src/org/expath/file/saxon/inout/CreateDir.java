...
/**
 * The file:create-dir function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.create-dir
 * @see http://expath.org/spec/file/20131203#fn.create-dir
 */
public class CreateDir
        extends Function
{
    public CreateDir(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
    ...
    private static final String LOCAL_NAME = "create-dir";
