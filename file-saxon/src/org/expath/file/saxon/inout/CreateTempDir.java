...
/**
 * The file:create-temp-dir function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.create-temp-dir
 * @see http://expath.org/spec/file/20131203#fn.create-temp-dir
 */
public class CreateTempDir
        extends Function
{
    public CreateTempDir(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            if ( orig_params.length == 2 ) {
                res = inout.createTempDir(prefix, suffix);
            }
            else {
                String dir = params.asString(2, false);
                res = inout.createTempDir(prefix, suffix, dir);
            }
    ...
    private static final String LOCAL_NAME   = "create-temp-dir";
