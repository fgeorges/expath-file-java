 ...
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.delete
 * @see http://expath.org/spec/file/20131203#fn.delete
 */
public class Delete
        extends Function
{
    public Delete(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            if ( orig_params.length == 1 ) {
                ...
                boolean recurse = params.asBoolean(1, false);
                inout.delete(path, recurse);
            }
            return Return.empty();
        }
    ...
    private static final String LOCAL_NAME  = "delete";
