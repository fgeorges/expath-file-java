...
/**
 * The file:append-binary function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.append-binary
 * @see http://expath.org/spec/file/20131203#fn.append-binary
 */
public class AppendBinary
        extends Function
{
    public AppendBinary(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
    ...
    private static final String LOCAL_NAME  = "append-binary";
