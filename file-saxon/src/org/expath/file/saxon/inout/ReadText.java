...
/**
 * The file:read-text function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.read-text
 * @see http://expath.org/spec/file/20131203#fn.read-text
 */
public class ReadText
        extends Function
{
    public ReadText(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            if ( orig_params.length == 1 ) {
                res = read.readText(file);
            }
            else {
                String encoding = params.asString(1, false);
                res = read.readText(file, encoding);
            }
    ...
    private static final String LOCAL_NAME = "read-text";
