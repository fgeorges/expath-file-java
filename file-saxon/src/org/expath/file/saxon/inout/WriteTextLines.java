...
/**
 * The file:write-text-lines function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.write-text-lines
 * @see http://expath.org/spec/file/20131203#fn.write-text-lines
 */
public class WriteTextLines
        extends Function
{
    public WriteTextLines(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            if ( orig_params.length == 2 ) {
                write.writeTextLines(file, lines);
            }
            else {
                String encoding = params.asString(2, false);
                write.writeTextLines(file, lines, encoding);
            }
            return Return.empty();
        }
    ...
    private static final String LOCAL_NAME  = "write-text-lines";
    private static final String PARAM_FILE  = "file";
    private static final String PARAM_LINES = "values";
