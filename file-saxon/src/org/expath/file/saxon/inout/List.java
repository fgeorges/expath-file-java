 ...
 * @date   2015-01-13
 * @see http://expath.org/spec/file#fn.list
 * @see http://expath.org/spec/file/20131203#fn.list
 */
public class List
        extends Function
{
    public List(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws ToolsException
    {
        return library()
                ...
                .returns(Types.ANY_STRING)
                .param(Types.SINGLE_STRING,  PARAM_DIR)
                .optional()
                .param(Types.SINGLE_BOOLEAN, PARAM_RECUR)
                .param(Types.SINGLE_STRING,  PARAM_PATTERN)
                .make();
    }
            ...
            throws XPathException
    {
        ...
        String dir = params.asString(0, false);
        // the actual call
        ...
        try {
            if ( orig_params.length == 1 ) {
                ...
                boolean recursive = params.asBoolean(1, false);
                if ( orig_params.length == 2 ) {
                    res = inout.list(dir, recursive);
                }
                else {
                    String pattern = params.asString(2, false);
                    res = inout.list(dir, recursive, pattern);
                }
            }
        }
    ...
    private static final String LOCAL_NAME    = "list";
    private static final String PARAM_DIR     = "dir";
    private static final String PARAM_RECUR   = "recursive";
