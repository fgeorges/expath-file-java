...
/**
 * The file:read-text-lines function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.read-text-lines
 * @see http://expath.org/spec/file/20131203#fn.read-text-lines
 */
public class ReadTextLines
        extends Function
{
    public ReadTextLines(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws XPathException
    {
        ...
        try {
            ...
            if ( orig_params.length == 1 ) {
                res = read.readTextLines(file);
            }
            else {
                String encoding = params.asString(1, false);
                res = read.readTextLines(file, encoding);
            }
    ...
    private static final String LOCAL_NAME = "read-text-lines";
