...
/**
 * The file:create-temp-file function.
 *
 * @author Florent Georges
 * @date   2015-01-14
 * @see http://expath.org/spec/file#fn.create-temp-file
 * @see http://expath.org/spec/file/20131203#fn.create-temp-file
 */
public class CreateTempFile
        extends Function
{
    public CreateTempFile(EXPathFileLibrary lib)
    {
        super(lib);
        myLib = lib;
    }
            ...
            throws ToolsException
    {
        return library()
                ...
                .param(Types.SINGLE_STRING, PARAM_PREFIX)
                .param(Types.SINGLE_STRING, PARAM_SUFFIX)
                .optional()
                .param(Types.SINGLE_STRING, PARAM_DIR)
                .make();
    }
            ...
            throws XPathException
    {
        ...
        String prefix = params.asString(0, false);
        String suffix = params.asString(1, false);
        // the actual call
        try {
            InputOutput inout = new InputOutput();
            String res;
            if ( orig_params.length == 2 ) {
                res = inout.createTempFile(prefix, suffix);
            }
            else {
                String dir = params.asString(2, false);
                res = inout.createTempFile(prefix, suffix, dir);
            }
    ...
    private static final String LOCAL_NAME   = "create-temp-file";
